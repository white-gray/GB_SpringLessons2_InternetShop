...
@Tag(name = "Контроллер заказов", description = "Методы работы с заказами")
public class OrdersController {
    ...
    @Operation(
            summary = "Создание заказа для определенного Пользовалеля",
            responses = {
                    @ApiResponse(
    ...
    @Operation(
            summary = "Запрос на состав заказа определенного Пользовалеля",
            responses = {
                    @ApiResponse(
                            description = "Успешный ответ", responseCode = "200",
                            content = @Content(schema = @Schema(implementation = Page.class))
